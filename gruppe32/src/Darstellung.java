...
public class Darstellung{
	...
	public static void levelDarstellen(int level) {
		...
		for (spalte=0;spalte<20;spalte++) {
			for(reihe=0;reihe<15;reihe++) {
				...
				if (Spielfeld.wertBeiXY(level,spalte,reihe)==0){
					StdDraw.picture(20+40*spalte,20+40*reihe, "boden.jpg"); 
				}
				else if (Spielfeld.wertBeiXY(level,spalte,reihe)==1){
					StdDraw.picture(20+40*spalte,20+40*reihe, "mauer.jpg");
				}
				else if (Spielfeld.wertBeiXY(level,spalte,reihe)==2){
					StdDraw.picture(20+40*spalte,20+40*reihe, "start.jpg");
				}
				else if (Spielfeld.wertBeiXY(level,spalte,reihe)==3){
					StdDraw.picture(20+40*spalte,20+40*reihe, "ziel.jpg");
				}
				else if (Spielfeld.wertBeiXY(level,spalte,reihe)==4){
					StdDraw.picture(20+40*spalte,20+40*reihe, "falle.jpg");
				}
				else if (Spielfeld.wertBeiXY(level,spalte,reihe)==5){
					StdDraw.picture(20+40*spalte,20+40*reihe, "mob.jpg");
				}
				else if (Spielfeld.wertBeiXY(level,spalte,reihe)==6){
	 ...
	 */
	public static void figurBewegen(int vonX, int vonY, int nachX, int nachY ){
